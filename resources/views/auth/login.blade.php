                    ...
                    <div class="col-lg-6">
                        <div class="info d-flex justify-content-center flex-column p-4 h-100">
                            <div class="py-5">
                                ...
                                <p class="fw-light mb-0">Login required to view Admin Dashboard.</p>
                            </div>
                        </div>
                    </div>
                    <!-- Form Panel    -->
                        ...
                        <div class="d-flex align-items-center px-4 px-lg-5 h-100 bg-dash-dark-2">
                            <form class="login-form py-5 w-100" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="input-material-group mb-3">
                                    <input class="input-material @error('email') is-invalid @enderror" id="email" type="email" name="email" value="{{ old('email') }}" autocomplete="off" required data-validate-field="email">
                                    @error('email')
                                ...
                                <div class="input-material-group mb-4">
                                    <input class="input-material @error('password') is-invalid @enderror" id="password" type="password" name="password" autocomplete="off">
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                @if (Route::has('password.request'))
                                    <a class="text-sm text-paleBlue" href="{{ route('password.request') }}">Forgot Password?</a>
                                @endif
                            </form>
                        </div>
                    </div>
